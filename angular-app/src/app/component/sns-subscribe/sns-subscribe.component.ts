...
import { SnsResponse, SnsSubscriptionRequest, SnsTopicListItem } from '../../model/sns-objects';
...
export class SnsSubscribeComponent implements OnInit {
    ...
    subscription: SnsSubscriptionRequest = { endpoint: '', protocol: '',  accountId: '186148884772', region: 'us-east-1', subject: '' };
